...
function Systems(){
  if(Random(4) == 0){
    ...
    doc2.innerHTML = Hcode[7] + Res_title[0] + Hcode[8] + "の方のラッキーアイテムはこちら↓";
    if(luckyItems(5) == 0){
    ...
    doc2.innerHTML = Hcode[7] + Res_title[1] + Hcode[8] + "の方のラッキーアイテムはこちら↓";
    if(luckyItems(5) == 0){
        item_HTML.innerHTML = Hcode[9] + Item[0] + Hcode[10];
    }else if(luckyItems(5) == 1){
        item_HTML.innerHTML = Hcode[9] + Item[1] + Hcode[10];
    ...
    doc2.innerHTML = Hcode[7] + Res_title[2] + Hcode[8] + "の方のラッキーアイテムはこちら↓";
    if(luckyItems(5) == 0){
        item_HTML.innerHTML = Hcode[9] + Item[0] + Hcode[10];
    }else if(luckyItems(5) == 1){
        item_HTML.innerHTML = Hcode[9] + Item[1] + Hcode[10];
    ...
    doc2.innerHTML = Hcode[7] + Res_title[3] + Hcode[8] + "の方のラッキーアイテムはこちら↓";
    if(luckyItems(5) == 0){
        item_HTML.innerHTML = Hcode[9] + Item[0] + Hcode[10];
    }else if(luckyItems(5) == 1){
        item_HTML.innerHTML = Hcode[9] + Item[1] + Hcode[10];
    ...
    doc2.innerHTML = Hcode[7] + Res_title[4] + Hcode[8] + "の方のラッキーアイテムはこちら↓";
    if(luckyItems(5) == 0){
        item_HTML.innerHTML = Hcode[9] + Item[0] + Hcode[10];
    }else if(luckyItems(5) == 1){
        item_HTML.innerHTML = Hcode[9] + Item[1] + Hcode[10];
